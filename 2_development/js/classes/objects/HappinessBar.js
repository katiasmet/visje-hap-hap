class HappinesBar extends Phaser.Sprite {
  ...
  constructor(game, width, height){
    ...
    this.width = width;
    this.darkBar = this.game.add.tileSprite(150, 70 , width-300, 30,'darkBar');

    this.lightBar = this.game.add.tileSprite(150, 77, (width-300) / 2, 16, 'lightBar');
    ...
    this.sadStar = this.game.add.sprite(100, 20 , 'assets', 'starfish_sad.png');
    this.happyStar = this.game.add.sprite(width-100-120, 20 , 'assets', 'starfish_happy.png');
  ...
  makeshorter(){
    ...
    this.game.add.tween(this.lightBarEnd.position).to( { x: this.lightBar.position.x + this.newWidth }, 500, "Linear", true);
